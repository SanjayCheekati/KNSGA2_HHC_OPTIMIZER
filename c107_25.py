"""
DEMO SCRIPT for K-NSGA-II Algorithm - C107.25 Instance
=========================================================
Second instance from Paper Table 5

C107 has WIDE time windows (Type 1, variant 07)
This makes it easier to find feasible solutions with low tardiness
"""
...
def run_c107_25_demo():
    print("=" * 60)
    print("K-NSGA-II - C107.25 Instance (Second Instance)")
    print("=" * 60)
    print("\nInstance Characteristics:")
    print("  - Type: Clustered (C)")
    print("  - Variant: 107 (wide time windows)")
    print("  - Customers: 25")
    ...
    # Load instance
    print("\n" + "-" * 60)
    print("Loading C107.25 instance...")
    instance = load_instance("C107.25")
    ...
    print("\n" + "=" * 60)
    print("C107.25 Instance Completed!")
    print("=" * 60)
