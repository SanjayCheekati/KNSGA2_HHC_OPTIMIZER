"""
DEMO SCRIPT for K-NSGA-II Algorithm - C206.25 Instance
=========================================================
Third instance from Paper Table 5

C206 has VERY WIDE time windows (Type 2)
This should make it easier to find solutions with low tardiness
"""
...
def run_c206_25_demo():
    print("=" * 60)
    print("K-NSGA-II - C206.25 Instance (Third Instance)")
    print("=" * 60)
    print("\nInstance Characteristics:")
    print("  - Type: Clustered (C)")
    print("  - Variant: 206 (very wide time windows)")
    print("  - Customers: 25")
    ...
    # Load instance
    print("\n" + "-" * 60)
    print("Loading C206.25 instance...")
    instance = load_instance("C206.25")
    ...
    print("\n" + "=" * 60)
    print("C206.25 Instance Completed!")
    print("=" * 60)
