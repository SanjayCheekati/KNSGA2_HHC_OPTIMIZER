"""
DEMO SCRIPT for K-NSGA-II Algorithm - R109.25 Instance
=========================================================
Fourth instance from Paper Table 5

R109 has RANDOM customer distribution (not clustered)
This tests the algorithm's ability to handle non-clustered data
"""
...
def run_r109_25_demo():
    print("=" * 60)
    print("K-NSGA-II - R109.25 Instance (Fourth Instance)")
    print("=" * 60)
    print("\nInstance Characteristics:")
    print("  - Type: Random (R)")
    print("  - Variant: 109 (random distribution)")
    print("  - Customers: 25")
    ...
    # Load instance
    print("\n" + "-" * 60)
    print("Loading R109.25 instance...")
    instance = load_instance("R109.25")
    ...
    print("\n" + "=" * 60)
    print("R109.25 Instance Completed!")
    print("=" * 60)
